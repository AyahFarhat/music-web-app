...
export default function CreatePlaylist() {
  ...
  // DONE : Gérer le changement de nom
  const handleNameChange = (event) => {
      setData({ ...data, name: event.target.value});

  };

  // DONE : Gérer le changement de description
  ...
  // DONE : Envoyer une requête de supression au serveur et naviguer vers la page principale
    ...
    <main id="main-area" className="flex-row">
      <form className="form-group" id="playlist-form">
        <div id="general-info" className="flex-row">
          <fieldset className="form-control">
            ...
            <div className="form-control flex-row">
              ...
              {/*DONE : lier au nom de la playlist */}
              <input
                type="text"
                id="name"
            ...
            <div className="form-control flex-row">
              ...
              {/*DONE : lier à la description de la playlist */}
              <input
                type="text"
                id="description"
        ...
        <fieldset className="form-control">
          ...
          {/*DONE : construire les choix de chansons dans des éléments <option> PROBABLY A BETTER WAY TO DO THIS*/}
          <datalist id="song-dataList">
           {
            songs.map((item) => {return <option value={item.name}/>})
           }
          </datalist>
        ...
        {/*DONE : afficher "Modifier la playlist" ou "Ajouter la playlist" en fonction de l'état du formulaire */}
